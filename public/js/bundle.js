...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGh1eWR1b25nOTAiLCJhIjoiY2thNjJzdTFpMDJ6dDJxb2hib3l3Z2FtcCJ9.7amqRkEXFZbhNqh5NR2NBw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/streets-v11',
    scrollZoom: false // center: [-118.249037, 34.070702],
    // zoom: 7
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:4000/api/v1/users/".concat(endPoint),
              data: data
            });
...
var stripe = Stripe('pk_test_hEohzW6C1oQN0SARQjU43h1200TKv918SW'); //const elements = stripe.elements();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://localhost:4000/api/v1/bookings/checkout-session/".concat(tourID)
            });
...
if (updateFormData) {
  updateFormData.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSetings)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateSettings.updateSetings)({
                password: password,
